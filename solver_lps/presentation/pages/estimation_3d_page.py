...
from solver_lps.features.uwb.realtime.three_d.presentation.widgets.app_widget import (
    main as realtime_main,
)
from solver_lps.features.uwb.review.three_d.presentation.widgets.app_widget import (
    main as review_main,
)


def parse_args(argv=None):
    parser = argparse.ArgumentParser(description="Estimation 3D page entrypoint.")
