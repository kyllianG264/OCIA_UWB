...
DEFAULT_CENTER_X = 1250.0
DEFAULT_CENTER_Y = 900.0
DEFAULT_TAG_BASE_Z_CM = 95.0
DEFAULT_WORLD_MIN_X = -450.0
DEFAULT_WORLD_MAX_X = 2950.0
DEFAULT_WORLD_MIN_Y = -350.0
DEFAULT_WORLD_MAX_Y = 2150.0
...
def estimate_position_3d_least_squares(anchor_positions, distances, initial_guess=None, iterations=18, damping=35.0):
    ...
    if initial_guess is None:
        point = [DEFAULT_CENTER_X, DEFAULT_CENTER_Y, DEFAULT_TAG_BASE_Z_CM]
    else:
    ...
    for _ in range(iterations):
        ...
        point[1] += step[1]
        point[2] += step[2]
        point[0] = clamp(point[0], DEFAULT_WORLD_MIN_X, DEFAULT_WORLD_MAX_X)
        point[1] = clamp(point[1], DEFAULT_WORLD_MIN_Y, DEFAULT_WORLD_MAX_Y)
...
def update_position_solution(anchors, distance_packet, state, dt, tag_real):
    ...
    initial_guess = state.get("tag_est_smooth") or (DEFAULT_CENTER_X, DEFAULT_CENTER_Y, DEFAULT_TAG_BASE_Z_CM)
