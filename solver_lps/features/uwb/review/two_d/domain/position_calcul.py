...
def _base_result(raw_distances, dist_smooth, distance_packet):
    return {
        ...
        "source": distance_packet.get("source", "realtime"),
        "status": distance_packet.get("status", "realtime"),
        "cv_positions": list(distance_packet.get("cv_positions", [])),
        "selected_player_id": distance_packet.get("selected_player_id"),
        "selection_mode": distance_packet.get("selection_mode", "single"),
        "all_player_ids": list(distance_packet.get("all_player_ids", [])),
        "selected_player_visible": distance_packet.get("selected_player_visible", False),
        "cv_status": distance_packet.get("cv_status"),
        "cv_video_frame": distance_packet.get("cv_video_frame"),
        "cv_video_available": distance_packet.get("cv_video_available", False),
        "cv_playback": distance_packet.get("cv_playback"),
        "uwb_playback": distance_packet.get("uwb_playback"),
        "raw_err": None,
        "smooth_err": None,
        "raw_precision": None,
