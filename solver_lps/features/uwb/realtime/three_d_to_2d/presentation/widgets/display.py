...
from solver_lps.features.ground.domain.court_geometry import draw_court_2d
from solver_lps.features.ground.domain.projection import ScreenProjection, project_world_point
...
from ...domain.scene import CAMERA_X, CAMERA_Y, SCALE, WIDTH, HEIGHT, anchor_colors
...
def world_to_screen(x_cm, y_cm):
    projection = ScreenProjection(
        left=CAMERA_X - (WIDTH / (2.0 * SCALE)),
        top=CAMERA_Y - (HEIGHT / (2.0 * SCALE)),
        scale=SCALE,
        offset_x=0.0,
        offset_y=0.0,
    )
