...
_SEGMENTS = (
    {"label": "receive outlet", "point": (-1110.0, 140.0), "duration": 1.15, "kind": "jog", "curve": 35.0, "sway": 10.0, "pace": 1.6},
    {"label": "push in transition", "point": (-340.0, 120.0), "duration": 2.00, "kind": "sprint", "curve": -90.0, "sway": 15.0, "pace": 2.8},
    {"label": "organize at top", "point": (120.0, -20.0), "duration": 1.35, "kind": "control", "curve": -130.0, "sway": 11.0, "pace": 1.8},
    {"label": "hard cut to wing", "point": (560.0, -250.0), "duration": 0.92, "kind": "burst", "curve": -150.0, "sway": 16.0, "pace": 3.0},
    {"label": "hesitation dribble", "point": (640.0, -180.0), "duration": 0.70, "kind": "hesi", "curve": 20.0, "sway": 18.0, "pace": 2.4},
    {"label": "baseline drive", "point": (980.0, -470.0), "duration": 0.90, "kind": "drive", "curve": -110.0, "sway": 18.0, "pace": 3.1},
    {"label": "attack rim", "point": (1030.0, -60.0), "duration": 0.80, "kind": "drive", "curve": 210.0, "sway": 14.0, "pace": 3.2},
    {"label": "land and drift out", "point": (260.0, 210.0), "duration": 1.45, "kind": "recovery", "curve": 170.0, "sway": 12.0, "pace": 2.0},
    {"label": "defensive slide", "point": (-470.0, 280.0), "duration": 1.35, "kind": "slide", "curve": 0.0, "sway": 14.0, "pace": 2.5},
    {"label": "closeout corner", "point": (-940.0, 450.0), "duration": 0.96, "kind": "burst", "curve": 70.0, "sway": 15.0, "pace": 2.9},
    {"label": "rebound crash", "point": (-140.0, 120.0), "duration": 1.02, "kind": "crash", "curve": 240.0, "sway": 13.0, "pace": 3.1},
    {"label": "box out reset", "point": (-40.0, 80.0), "duration": 0.74, "kind": "hold", "curve": 10.0, "sway": 20.0, "pace": 1.7},
    {"label": "outlet run right seam", "point": (780.0, 60.0), "duration": 1.42, "kind": "sprint", "curve": -120.0, "sway": 14.0, "pace": 2.9},
    {"label": "curl to elbow", "point": (220.0, -240.0), "duration": 1.24, "kind": "curl", "curve": -220.0, "sway": 12.0, "pace": 2.2},
    {"label": "step back slot", "point": (-280.0, -70.0), "duration": 0.98, "kind": "stepback", "curve": 120.0, "sway": 16.0, "pace": 2.6},
    {"label": "relocate weak side", "point": (-760.0, -390.0), "duration": 1.36, "kind": "jog", "curve": -80.0, "sway": 11.0, "pace": 1.8},
    {"label": "lift from corner", "point": (-300.0, -180.0), "duration": 1.06, "kind": "control", "curve": 130.0, "sway": 12.0, "pace": 2.0},
    {"label": "middle attack pullup", "point": (340.0, 90.0), "duration": 1.05, "kind": "burst", "curve": 180.0, "sway": 15.0, "pace": 2.8},
    {"label": "reset spacing", "point": (20.0, 170.0), "duration": 1.18, "kind": "recovery", "curve": -95.0, "sway": 10.0, "pace": 1.7},
)
