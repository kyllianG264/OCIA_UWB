...
def parse_args():
    parser = argparse.ArgumentParser(description="Estimation UWB 3D vers 2D.")
    ...
    try:
        while running:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_ESCAPE:
                        ...
                        full_reset(state, active_anchor_count)
                    elif event.key == pygame.K_SPACE and source.uses_simulated_tag:
                        start_jump(state)
            ...
            if source.uses_simulated_tag:
                ...
                tag_real, tag_height, jump_extra = None, None, None
