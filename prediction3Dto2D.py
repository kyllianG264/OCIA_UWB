...
# CONFIG HAUTEURS (cm)
# =========================
ANCHOR_HEIGHT_CM = 1500.0          # hauteur des Portenta
TAG_BASE_HEIGHT_CM = 10.0         # hauteur normale Stella
TAG_ASSUMED_HEIGHT_CM = 00.0      # hauteur supposée par le solveur 2D

# =========================
# SAUTS VERTICAUX
# =========================
JUMP_EXTRA_HEIGHT_CM = 120.0      # saut de ~1 m
